...
<?php 
        ...
        <input type='file' name='u_image' size='900'>
        </label>
        ...
        if(isset($_POST['update'])){
            ...
            $image_tap = $_FILES['u_image']['tmp_name'];
            ...
            if($u_image==''){
                ...
                move_uploaded_file($image_tap, "images/$u_image");
                $update = "update users set user_profile='images/$u_image' where user_email='$user'";
