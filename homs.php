...
<body>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-3 col-xs-12 left-sidebar">
                <div class="input-group searchbox">
                    <div class="input-group-btn">
                        <a href="include/find_friends.php"><button class="btn btn-default search-icon"  style text-align:center; name="search_user" type="submit">Add New USer</button></a>
                    </div>
                </div>
                <div class="left-chat">
                    <ul>
            ...
            <div class="col-md-9 col-sm-9 col-xs-12 right-sidebar">
                ...
                ?>
                    ...
                    <!-- Getting user data on which person clicks -->
                ...
                <div class="row">
                    <div class="col-md-12 right-chat-textbox">
                        <form method="POST">
                            <input type="text" autocomplete="off" name="msg_content" placeholder="write your msg...">
    ...
    if(isset($_POST['submit'])){
        ...
        if($msg == ''){
            ...
            echo '<div class="alert alert-danger">
            <strong><center>MEssage was too long </center></strong>
            </div>';
        }
        else{
